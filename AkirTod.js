...
case 'tiktokmp3':
             ...
             sticWait(from)
             ini_link = args[0]
             get_audio = await getBuffer(`https://api.lolhuman.xyz/api/tiktokmusic?apikey=KONTOLODON&url=${ini_link}`)
...
*「 🤖 HENTONGERS-BOT 🤖 」*`
         kirbotz = await getBuffer(ppimg)
                ...
                ,
                { buttonId: `${prefix}allmenu`, buttonText: { displayText: '😎 LONCAT ALLMENU 😎' }, type: 1 }
                ]
